...
alter table AUDIT_LOG
    add(constraint pk_audit_log PRIMARY KEY(user_id,action),
        constraint fk_user_id_audit_log FOREIGN KEY(user_id) references APP_USER(user_id)
        );